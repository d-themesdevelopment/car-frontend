          ...
          <div className="grid grid-cols-12 grid-flex-row gap-5">
            <div className="col-span-12 md:col-span-6 lg:col-span-3">
              <div className="widget">
                <h4 className="text-2xl font-medium mb-10">Landing</h4>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3">
              <div className="widget">
                <h4 className="text-2xl font-medium mb-10">Shop</h4>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3">
              <div className="widget">
                <h4 className="text-2xl font-medium mb-10">Parts</h4>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3">
              <div className="widget">
                <h4 className="text-2xl font-medium mb-10">Turning</h4>
